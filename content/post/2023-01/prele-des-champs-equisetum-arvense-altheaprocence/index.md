...
{{< blockcontainer jli-notice-warning "Toxicité" >}}
...
{{< blockcontainer jli-notice-tip "Article de Christophe" >}}
...
{{< blockcontainer jli-notice-note "Pour la petite histoire…">}}
...
{{< blockcontainer jli-notice-tip "Chaleur dans l’eau vs chaleur sèche" >}}
...
{{< blockcontainer jli-notice-note "Par exemple" >}}
...
{{< blockcontainer jli-notice-tip "Refermer les plais difficiles à se refermer" >}}
...
{{< blockcontainer jli-notice-warning "Consulter d'abord pour connaitre la cause des saignements" >}}
...
{{< blockcontainer jli-notice-note " Une autre plante <i>cousine</i>" >}}
...
{{< blockcontainer jli-notice-tip "Parallèle avec la vitamine C" >}}
...
{{< blockcontainer jli-notice-warning "Finesse du tamis" >}}
...
{{< blockcontainer jli-notice-warning "Consulter d'abord pour connaitre la cause du problème" >}}
...
{{< blockcontainer jli-notice-tip "Infusion vs décoction" >}}
...
On en reparlera avec [Damien Dekarz](../../../tags/damien-dekarz).
